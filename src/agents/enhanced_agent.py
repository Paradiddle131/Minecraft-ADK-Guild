...
class EnhancedMinecraftAgent:
    ...
    async def initialize(self):
        ...
        # Create tools (not used when output_schema is specified)
...
Note: You cannot use tools directly. Instead, plan the actions and specify which tools should be used in your actions array."""
    ...
    class StructuredResponse(BaseModel):
        ...
        actions: List["EnhancedMinecraftAgent.ActionItem"] = Field(description="Specific actions to take with reasoning")
